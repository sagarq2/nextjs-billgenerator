    ...
    return (
        <section className={`${style.Banner}`} role="banner">
            <div className={`${style.BannerTxt}`}>
                <h1 role="heading" tabIndex="0" id="title" className={`${style.BannerHeading} font30 fw400 colorFFF`}>Accurate, fast and secure <span className="color00A"> Bill Generator</span></h1>
                <div className={` font16 fw400 colorFFF mt-5`}>
                ...
                <button className={`${style.BannerButton} font16 fw500 colorFFF mt-20`} onClick={() => router.push('/bills')}>Try It Free</button>
            </div>
            <div className={`${style.BannerImage} `}>
                {/* <img className={`${style.Image} `} src="https://billgenerator.in/assets/img/banner/1.png" /> */}
